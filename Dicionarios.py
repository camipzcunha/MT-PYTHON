...
def ids_dos_melhor_classificados(dados,numero_de_times):
    pass
    lista_melhores = []
    while len(lista_melhores) < numero_de_times:
        lista_melhores.append(dados['fases']['2700']['classificacao']['grupo']['Único'][len(lista_melhores)])
...
def classificados_libertadores(dados):
    pass
    ids = ids_dos_melhor_classificados(dados,qtos_libertadores(dados))
    return ids
'''
...
def nomes_dos_times_de_um_jogo(dados,id_jogo):
   pass
   time1  = nome_do_time(dados,dados['fases']['2700']['jogos']['id'][id_jogo]['time1'])
   time2  = nome_do_time(dados,dados['fases']['2700']['jogos']['id'][id_jogo]['time2'])
   return time1,time2
...
def data_de_um_jogo(dados,id_jogo):
    pass
    for data in dados['fases']['2700']['jogos']['data']:
        if id_jogo in dados['fases']['2700']['jogos']['data'][data]:
            return data
    return 'nao encontrado'
...
def dicionario_id_estadio_e_nro_jogos(dados):
    ...
    for jogo in dados['fases']['2700']['jogos']['id']:
        estadio = dados['fases']['2700']['jogos']['id'][jogo]['estadio_id']
